    ...
    <div className="container text-center mt-5">
      ...
      <div className="row justify-content-center align-items-center">
        <div className="col-md-6">
          ...
          <h1 className="fw-bold">
            Mentoria Elite BJJ 40+: Saúde, Performance e Longevidade
          </h1>
      ...
      <div className="mt-5">
        <div className="ratio ratio-16x9">
          <iframe
            src="https://fast.wistia.net/embed/iframe/q7nk9cni7d" // Change this to your Wistia video URL
      ...
      <div className="w-100 mt-5">
        ...
        <img
          src="/bjj40-images/bjj-casos.jpg"
          alt="BJJ Success Stories Showcase" // Improved alt text
          className="img-fluid w-100 bjj-full-width-image" // Added custom class for responsiveness
        />
      </div>
